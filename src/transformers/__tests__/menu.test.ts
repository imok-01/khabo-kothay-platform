...
function bundle(): MenuDbBundle {
  ...
  const observations: PriceObservationsRow[] = [
    { id: 'obs-1', menu_item_id: 'item-1', price: 280, currency: 'BDT', source_id: 'src-web', observed_at: '2025-06-10T00:00:00Z' },
    { id: 'obs-2', menu_item_id: 'item-1', price: 320, currency: 'BDT', source_id: 'src-web', observed_at: '2026-01-15T00:00:00Z' },
    // NULL price — genuinely unknown, must stay unknown (→ price 0 / not listed)
    { id: 'obs-3', menu_item_id: 'item-2', price: null, currency: 'BDT', source_id: null, observed_at: '2026-01-15T00:00:00Z' },
  ];
